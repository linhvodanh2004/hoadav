...
export default function Contact() {
  return (
    <section className="py-24 px-8 md:px-16 bg-brutal-black text-brutal-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="font-brutal text-7xl md:text-[8rem] text-brutal-orange drop-shadow-[5px_5px_0_rgba(244,244,240,1)] leading-none mb-12"
        >
          LET'S TALK
        </motion.h2>
        ...
        <motion.div 
           ...
           className="mt-24 pt-8 border-t-4 border-brutal-white/20 w-full font-sans font-bold text-brutal-white/50 flex flex-col md:flex-row justify-between items-center"
        >
          <p>© 2028 VUONG DIEU HOA.</p>
